        ...
        <div>
            {(() => {
                switch (content.type) {
                    ...
                    case 'scatter_plot':
                        return <div className="p-4"><ScatterPlotComponent {...content} /></div>;
                    case 'waterfall_chart':
                        return <div className="p-4"><WaterfallChartComponent {...content} /></div>;
                    case 'report':
        ...
        return (
            <div className="w-full h-full flex items-center justify-center p-6 bg-slate-50">
                <div className="text-center text-gray-500">
                    <ChartIcon className="w-16 h-16 mx-auto mb-4 text-gray-300" />
                ...
                <div className="flex border-b border-gray-200 overflow-x-auto flex-shrink-0">
                    {artifacts.map((artifact, index) => (
                        <button
                            ...
                            className={`flex items-center px-4 py-2 text-sm font-medium -mb-px border-b-2 whitespace-nowrap ${activeTabIndex === index ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
